/**
 * LAYER 1/2 — UIControls: Top control bar (2 rows)
 *
 * Row 1: Turno selector | Phase buttons | Color swatches | Repetir
 * Row 2: Tirar dados    | +ND6 buttons  | Count display  | Limpiar
 */
